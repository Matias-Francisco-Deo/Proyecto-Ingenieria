  ...
  */
  ...
  async function handleProperty(event: FormEvent<HTMLFormElement>): Promise<void> {
    ...
    */
    ...
    const propertyDesc = form.elements.namedItem("description") as HTMLInputElement;
    const propertyUbication = form.elements.namedItem("ubication") as HTMLInputElement;
    ...
    const propertyStartTime = form.elements.namedItem("start-event") as HTMLInputElement;
    const propertyEndTime = form.elements.namedItem("end-event") as HTMLInputElement;
    const propertyCapacity = form.elements.namedItem("capacity") as HTMLInputElement;
    const propertyConditions = form.elements.namedItem("conditions") as HTMLInputElement;
    const propertyCancellation = form.elements.namedItem("cancellation-policy") as HTMLSelectElement;
    ...
    if (propertyNameIsBlank || propertyDescIsBlank || propertyUbicationIsBlank || propertyImageIsBlank
        || propertyPriceIsBlank || propertyStartTimeIsBlank || propertyEndTimeIsBlank || propertyCapacityIsBlank
        || propertyConditionsIsBlank || propertyCancellationIsBlank
    ) {
      ...
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          >
            ...
            <div>
              <label htmlFor="description" className="block font-medium text-sm/6">
                Descripción
              </label>
              <div className="mt-2">
                <input
            ...
            <div>
              ...
              <div className="mt-2 flex gap-4">
                <div className="flex-1">
                    <label htmlFor="start-event" className="block font-medium text-sm/6">
                        Inicio
                    </label>
                    <input
                    id="start-event"
                ...
                <div className="flex-1">
                    <label htmlFor="end-event" className="block font-medium text-sm/6">
                        Fin
                    </label>
                    <input
                    id="end-event"
